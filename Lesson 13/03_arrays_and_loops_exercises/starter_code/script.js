...
function alphabetLength(oneArray){
...
let milkyWayGalaxy = ['Mercury','Venus','Earth','Mars','Jupiter','Saturn','Uranus','Neptune','Pluto'];

// Remove the last planet from the array (sorry Pluto)

milkyWayGalaxy.pop();

console.log(milkyWayGalaxy);

// Add a new planet to the end of the array

milkyWayGalaxy.push("HIP 13044 b");

console.log(milkyWayGalaxy);

// Print your new array to the dom

document.querySelector("#exercise-two").textContent = milkyWayGalaxy.join(', ');
...
for (let i = 0; i < snacks.length; i++){
  ...
  console.log(`I'm craving motherfuckin ${snacks[i]}`);
}
